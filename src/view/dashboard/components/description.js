      ...
      <DescriptionStyle>
        <Container className="text-center">
          ...
          <div className="text-center">
            ...
            <p className="text-brown">
            The Hempire  contracts is public, verified and can be viewed here on <a href="https://bscscan.com/address/0x395842395D31bB3F4CAc7A5e8Eb2241bC46CD331" target="_blink">Contract</a>
            </p>
          </div>
          <div className="text-center">
